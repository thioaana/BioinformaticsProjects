...
if __name__ == "__main__":
    RNAStrand = "AUGGCCAUGGCGCCCAGAACUGAGAUCAAUAGUACCCGUAUUAACGGGUGA"
    ...
    protein = ""
    for i in range(0, len(RNAStrand) - len(RNAStrand)%3, 3):
        partStrand = RNAStrand[i:i+3]
        if rna_codon[partStrand] == "STOP":
            break
        protein += rna_codon[partStrand]
